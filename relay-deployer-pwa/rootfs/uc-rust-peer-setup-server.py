...
ENV_FILE = os.environ.get("ENV_FILE", "/etc/default/uc-rust-peer")
READY_FILE = os.environ.get("READY_FILE", "/etc/default/uc-rust-peer.ready")
CONFIGURE_SCRIPT = "/usr/local/sbin/uc-rust-peer-configure.sh"
...
class Handler(BaseHTTPRequestHandler):
    server_version = "UcRustPeerSetup/1.0"
